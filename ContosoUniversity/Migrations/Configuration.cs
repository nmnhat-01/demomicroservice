namespace ContosoUniversity.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SchoolContext>
    {
        ...
        protected override void Seed(SchoolContext context)
        {
            ...
            instructors.ForEach(s => context.Instructor.AddOrUpdate(p => p.LastName, s));
            context.SaveChanges();
            ...
            courses.ForEach(s => context.Course.AddOrUpdate(p => p.CourseID, s));
            context.SaveChanges();
            ...
            officeAssignments.ForEach(s => context.OfficeAssignment.AddOrUpdate(p => p.Location, s));
            context.SaveChanges();
        ...
        {
            var crs = context.Course.SingleOrDefault(c => c.Title == courseTitle);
            var inst = crs.Instructor.SingleOrDefault(i => i.LastName == instructorName);
            if (inst == null)
                crs.Instructor.Add(context.Instructor.Single(i => i.LastName == instructorName));
        }
    }
}
